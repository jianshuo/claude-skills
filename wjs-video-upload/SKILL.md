...
- YouTube Shorts variants from horizontal source (use `wjs-video-crop` first to produce the 9:16 cut, then upload that via this skill)
...
```bash
python3 ~/.claude/skills/wjs-video-upload/scripts/upload_youtube.py \
  --dir "/path/to/final" \
